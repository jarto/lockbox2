...
procedure BFEncryptString(const InString : RawByteString; var OutString : RawByteString;
            const Key : TKey128; Encrypt : Boolean);
procedure BFEncryptStringCBC(const InString : RawByteString; var OutString : RawByteString;
            const Key : TKey128; Encrypt : Boolean);
procedure DESEncryptString(const InString : RawByteString; var OutString : RawByteString;
            const Key : TKey64; Encrypt : Boolean);
procedure DESEncryptStringCBC(const InString : RawByteString; var OutString : RawByteString;
            const Key : TKey64; Encrypt : Boolean);
procedure TripleDESEncryptString(const InString : RawByteString; var OutString : RawByteString;
            const Key : TKey128; Encrypt : Boolean);
procedure TripleDESEncryptStringCBC(const InString : RawByteString; var OutString : RawByteString;
            const Key : TKey128; Encrypt : Boolean);
procedure RDLEncryptString(const InString : RawByteString; var OutString : RawByteString;
            const Key; KeySize : Longint; Encrypt : Boolean);
procedure RDLEncryptStringCBC(const InString : RawByteString; var OutString : RawByteString;
            const Key; KeySize : Longint; Encrypt : Boolean);

function BFEncryptStringEx(const InString : RawByteString;
            const Key : TKey128; Encrypt : Boolean) : RawByteString;
function BFEncryptStringCBCEx(const InString : RawByteString;
            const Key : TKey128; Encrypt : Boolean) : RawByteString;
function DESEncryptStringEx(const InString : RawByteString;
            const Key : TKey64; Encrypt : Boolean) : RawByteString;
function DESEncryptStringCBCEx(const InString : RawByteString;
            const Key : TKey64; Encrypt : Boolean) : RawByteString;
function TripleDESEncryptStringEx(const InString : RawByteString;
            const Key : TKey128; Encrypt : Boolean) : RawByteString;
function TripleDESEncryptStringCBCEx(const InString : RawByteString;
            const Key : TKey128; Encrypt : Boolean) : RawByteString;
function RDLEncryptStringEx(const InString : RawByteString;
            const Key; KeySize : Longint; Encrypt : Boolean) : RawByteString;
function RDLEncryptStringCBCEx(const InString : RawByteString;
            const Key; KeySize : Longint; Encrypt : Boolean) : RawByteString;
...
function BFEncryptStringEx(const InString : RawByteString; const Key : TKey128; Encrypt : Boolean) : RawByteString;
var
...
{ -------------------------------------------------------------------------- }
function BFEncryptStringCBCEx(const InString : RawByteString; const Key : TKey128; Encrypt : Boolean) : RawByteString;
var
  InStream  : TMemoryStream;
  OutStream : TMemoryStream;
  WorkStream : TMemoryStream;
...
{ -------------------------------------------------------------------------- }
procedure BFEncryptString(const InString : RawByteString; var OutString : RawByteString; const Key : TKey128; Encrypt : Boolean);
begin
  OutString := BFEncryptStringEx(InString, Key, Encrypt);
end;

{ -------------------------------------------------------------------------- }
procedure BFEncryptStringCBC(const InString : RawByteString; var OutString : RawByteString; const Key : TKey128; Encrypt : Boolean);
begin
  OutString := BFEncryptStringCBCEx(InString, Key, Encrypt);
end;

{ == DES string encryption/decryption ====================================== }
function DESEncryptStringEx(const InString : RawByteString; const Key : TKey64; Encrypt : Boolean) : RawByteString;
var
  InStream  : TMemoryStream;
  OutStream : TMemoryStream;
  WorkStream : TMemoryStream;
...
{ -------------------------------------------------------------------------- }
function DESEncryptStringCBCEx(const InString : RawByteString; const Key : TKey64; Encrypt : Boolean) : RawByteString;
var
  InStream  : TMemoryStream;
  OutStream : TMemoryStream;
  WorkStream : TMemoryStream;
...
{ -------------------------------------------------------------------------- }
procedure DESEncryptString(const InString : RawByteString; var OutString : RawByteString; const Key : TKey64; Encrypt : Boolean);
begin
  OutString := DESEncryptStringEx(InString, Key, Encrypt);
end;

{ -------------------------------------------------------------------------- }
procedure DESEncryptStringCBC(const InString : RawByteString; var OutString : RawByteString; const Key : TKey64; Encrypt : Boolean);
begin
  OutString := DESEncryptStringCBCEx(InString, Key, Encrypt);
end;

{ == TripleDES string encryption/decryption ================================ }
function TripleDESEncryptStringEx(const InString : RawByteString; const Key : TKey128; Encrypt : Boolean) : RawByteString;
var
  InStream  : TMemoryStream;
  OutStream : TMemoryStream;
  WorkStream : TMemoryStream;
...
{ -------------------------------------------------------------------------- }
function TripleDESEncryptStringCBCEx(const InString : RawByteString; const Key : TKey128; Encrypt : Boolean) : RawByteString;
var
  InStream  : TMemoryStream;
  OutStream : TMemoryStream;
  WorkStream : TMemoryStream;
...
{ -------------------------------------------------------------------------- }
procedure TripleDESEncryptString(const InString : RawByteString; var OutString : RawByteString; const Key : TKey128; Encrypt : Boolean);
begin
  OutString := TripleDESEncryptStringEx(InString, Key, Encrypt);
end;

{ -------------------------------------------------------------------------- }
procedure TripleDESEncryptStringCBC(const InString : RawByteString; var OutString : RawByteString; const Key : TKey128; Encrypt : Boolean);
begin
  OutString := TripleDESEncryptStringCBCEx(InString, Key, Encrypt);
end;

{ == Rijndael string encryption/decryption ================================== }
function RDLEncryptStringEx(const InString : RawByteString; const Key; KeySize : Longint; Encrypt : Boolean) : RawByteString;
var
  InStream  : TMemoryStream;
  OutStream : TMemoryStream;
  WorkStream : TMemoryStream;
...
{ -------------------------------------------------------------------------- }
function RDLEncryptStringCBCEx(const InString : RawByteString; const Key; KeySize : Longint; Encrypt : Boolean) : RawByteString;
var
  InStream  : TMemoryStream;
  OutStream : TMemoryStream;
  WorkStream : TMemoryStream;
...
{ -------------------------------------------------------------------------- }
procedure RDLEncryptString(const InString : RawByteString; var OutString : RawByteString; const Key; KeySize : Longint; Encrypt : Boolean);
begin
  OutString := RDLEncryptStringEx(InString, Key, KeySize, Encrypt);
end;

{ -------------------------------------------------------------------------- }
procedure RDLEncryptStringCBC(const InString : RawByteString; var OutString : RawByteString; const Key; KeySize : Longint; Encrypt : Boolean);
begin
